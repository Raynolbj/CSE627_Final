...
def clean_and_skeletonize(pred):
    ...
    binary_pred = closing(binary_pred, footprint)  # only closing
...
def main():
    ...
    with torch.no_grad():
        ...
        axes[2].set_title('Thresholded + Closed')
        ...
        csv_path = os.path.join(results_dir, f"node_metrics_single_eval_{timestamp}.csv")
